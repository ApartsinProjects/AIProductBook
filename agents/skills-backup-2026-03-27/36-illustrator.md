...
python "C:/Users/apart/.claude/skills/gemini-imagegen/scripts/generate_image.py" \
  ...
  --output "{chapter-folder}/images/{descriptive-filename}.png" \
  --aspect-ratio 4:3 \
  --image-size 1K
```
...
The following are example illustration ideas organized by topic area. Adapt these concepts to fit the specific book content.
